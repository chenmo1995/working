...
public class BaseMapperTest {
    ...
    void contextLoads() {
        ...
        pageQuery.select("id", "name", "age").likeRight("name", "修改");
...
//        List<MpUserPojo> mpUserList = userMapper.selectBatchIds(new ArrayList<>());
        ...
        /**
         * 分页查询，需要额外配置MyBatis-Plus提供的分页插件，{@link com.fudn.mybatisplusdemo.config.MybatisPlusConfig}
         *
         * 会发送两条SQL：
         *
         * 1.查询总数量
...
//        userMapper.deleteByMap()
     ...
     * <p>
     * 支持乐观锁分两步：
     * 1.配置乐观锁插件 {@link com.fudn.mybatisplusdemo.config.MybatisPlusConfig}
     * 2.DO字段上加@Version
     * <p>
